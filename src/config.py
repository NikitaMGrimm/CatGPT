...
class Config:
    ...
    CHATGPT_MODEL_ALIASES: str = os.getenv(
        ...
        "gpt-5.5=Latest 5.5|GPT-5.5,gpt-5=GPT-5,gpt-5-mini=GPT-5 mini,gpt-5-nano=GPT-5 nano,gpt-5.3=GPT-5.3,o3=o3,o4-mini=o4-mini,gpt-4.5=GPT-4.5,gpt-4.1=GPT-4.1,gpt-4.1-mini=GPT-4.1 mini,gpt-4o=GPT-4o",
    )
